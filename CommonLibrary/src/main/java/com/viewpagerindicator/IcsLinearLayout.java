...
public class IcsLinearLayout extends LinearLayout {
    ...
    /* 0 */R.attr.dividers,
    /* 1 */R.attr.showDivider,
    /* 2 */R.attr.dividersPadding,};
    ...
    public IcsLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, R.attr.vpiTabPageIndicatorStyle);
    }

    public IcsLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0, R.attr.vpiTabPageIndicatorStyle);
    }

    public IcsLinearLayout(Context context) {
        this(context, null, 0, R.attr.vpiTabPageIndicatorStyle);
    }

    public IcsLinearLayout(Context context, AttributeSet attrs, int defStyleAttr, int themeAttr) {
