...
public class StickyGridHeadersGridView extends GridView implements OnScrollListener, OnItemClickListener,
                            ...
                            if (!mDataChanged) {
                                ...
                                mTouchModeReset = new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        setPressed(false);
                                        header.invalidate();
                                        invalidate(0, header.getTop(),
                                                getWidth(), header.getHeight());
                                        if (!mDataChanged) {
                                            performHeaderClick.run();
                                        }
                                    }
                                };
                                postDelayed(mTouchModeReset, ViewConfiguration
    ...
    public void setOnHeaderLongClickListener(
                ...
                if (firstVisibleItem == 0 && super.getChildAt(0).getTop() > 0
                    ...
                    if (mClippingToPadding) {
                        ...
                        mHeaderBottomPosition = mHeaderBottomPosition < 0
                                ? headerHeight : mHeaderBottomPosition;
                    }
                }
            } else {
    ...
    private class CheckForHeaderLongPress extends WindowRunnable
        ...
        public void run() {
            ...
            if (child != null) {
                final long longPressId = headerViewPositionToId(
