...
public class MutilRadioGroup extends LinearLayout {
    ...
    public MutilRadioGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    /*@TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public MutilRadioGroup(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void addView(final View child, int index, ViewGroup.LayoutParams params) {
        if (child instanceof RadioButton) {
            throw new RuntimeException("Not Support RadioButton Child");
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (view instanceof RadioButton) {
                    ...
                    throw new RuntimeException("Only Support ViewGroup->RadioButton Child");
                }
            }
        }
    ...
    private class CheckedStateTracker implements CompoundButton.OnCheckedChangeListener {
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            ...
            if (mOnCheckedChangeListener != null) {
                mOnCheckedChangeListener.onCheckedChanged(MutilRadioGroup.this, id);
            }
        }
    }
    ...
    private class PassThroughHierarchyChangeListener implements OnHierarchyChangeListener {
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == MutilRadioGroup.this && child instanceof RadioButton) {
                int id = child.getId();
