...
public abstract class VideoAsyncTask<Params, Progress, Result> {
    private static final String LOG_TAG = "VideoAsyncTask";

    private static final int CORE_POOL_SIZE = 5;
    private static final int MAXIMUM_POOL_SIZE = 128;
    private static final int KEEP_ALIVE = 1;

    public static boolean mHasTasks = false;
    ...
    private static class SerialExecutor implements Executor {
        ...
        protected void scheduleNext() {
            synchronized(VideoAsyncTask.class){
     ...
     */
    public final VideoAsyncTask<Params, Progress, Result> execute(Params... params) {
     ...
     * @see #execute(Object[])
     */
    public final VideoAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec,
                                                                            Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
        final VideoAsyncTask mTask;
        final Data[] mData;

        AsyncTaskResult(VideoAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
