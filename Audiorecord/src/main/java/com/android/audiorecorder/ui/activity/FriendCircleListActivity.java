...
public class FriendCircleListActivity extends BaseCompatActivity implements OnClickListener {
    ...
    protected void setOptionView(TextView option) {
    	...
    	option.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(FriendCircleListActivity.this, FriendCircleActivePublishActivity.class);
    ...
    private void initData() {
        ...
        mFinalBit.display(mHeadIconImageView,  URLS.DOMAIN + mUserResp.headIcon);
    }
	...
	private class FriendCircleActiveFlush implements FlushListView{
		...
		public void getReplyByTrendId(Object tag) {
			Toast.makeText(FriendCircleListActivity.this, "getReplyByTrendId ", Toast.LENGTH_SHORT).show();
		}

		@Override
		public void getViewPosition(int position) {
			Toast.makeText(FriendCircleListActivity.this, "getViewPosition " + position, Toast.LENGTH_SHORT).show();
		}
		...
		public void saveReply(FriendCircleActiveCommentResp reply) {
			Toast.makeText(FriendCircleListActivity.this, "saveReply　", Toast.LENGTH_SHORT).show();
		}
		...
		public void showDel(TextView view, String userId) {
			Toast.makeText(FriendCircleListActivity.this, "showDel " + userId, Toast.LENGTH_SHORT).show();
		}
