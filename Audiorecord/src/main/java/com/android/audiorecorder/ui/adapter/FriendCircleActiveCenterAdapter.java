...
public class FriendCircleActiveCenterAdapter extends BaseAdapter implements OnClickListener {
	...
	public FriendCircleActiveCenterAdapter(Context context, PopupWindow window,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder holder;
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(R.layout.layout_friend_circle_person_center_item, null);
