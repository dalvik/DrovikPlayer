...
import com.android.audiorecorder.ui.adapter.PhoneRecordListAdapter;
...
public class PhoneRecordList extends BaseCompatActivity implements
    ...
    private String TAG = "PhoneRecordList";
    ...
    private PhoneRecordListAdapter mPhoneRecorddapter;
        ...
        public void handleMessage(Message msg) {
            switch(msg.what){
                case MSG_REFRESH_LIST:
                    mPhoneRecorddapter.notifyDataSetChanged();
                    break;
                case REFRESH:
                    if(!mFromTouch){
                ...
                case MSG_LOAD_FILE_LIST:
                    int page = msg.arg1;
                    List<FileDetail> list = mFileManager.loadFileList(true, AppContext.CATALOG_TEL_LIST, mThumbName, page, mFileList.size()%PAGE_NUMBER, launchType);
                    int len = list.size();
    ...
    public void onCreate(Bundle paramBundle) {
        ...
        setContentView(R.layout.activity_phone_record_timeline_gridview);
        setTitle(R.string.phone_record_list_title);
        mRefreshLayout = (RefreshLayout) findViewById(R.id.refreshLayout);
        refreshLayoutHeader = (ClassicsHeader) findViewById(R.id.refreshLayout_header);
        mLocalImageGridView = (GridView) findViewById(R.id.listView);
        mNoContent = (RelativeLayout) findViewById(R.id.activity_nocontent);
        ...
        mPhoneRecorddapter = new PhoneRecordListAdapter(this, mFileList, mLocalImageGridView);
        mLocalImageGridView.setAdapter(mPhoneRecorddapter);
        mOffset = 0;
        ...
        mLocalImageGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                FileDetail info = mPhoneRecorddapter.getItem(position);
                File file = new File(info.getFilePath());
                if(file.exists()){
                    Intent intent = OpenFiles.getVideoFileIntent(PhoneRecordList.this, file);
        ...
        registerForContextMenu(this.mLocalImageGridView);
                    ...
                    if(MediaPlaybackService.PLAY_COMPLETE_ACTION.equals(intent.getAction())){
                        ...
                        if(mService != null){
                            try {
                                ...
                                //mPhoneRecorddapter.setPlayId(playPositoin, PAUSE);
                                mHandler.sendEmptyMessage(MSG_REFRESH_LIST);
            ...
            if ((now - mLastSeekEventTime) > 250) {
                ...
                try {
                    if(mPosOverride<=mDuration){
                        mCurrentTime.setText(MusicUtils.makeTimeString(PhoneRecordList.this, mPosOverride / 1000));
