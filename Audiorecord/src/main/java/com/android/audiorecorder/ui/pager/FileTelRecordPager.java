    ...
    protected View createView(LayoutInflater inflater, Bundle savedInstanceState) {
        ...
        mRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshlayout) {
                ...
                mOffset = 0;
                mPageIndex = 0;
                loadThumbByCatalog(AppContext.CATALOG_TEL_AUDIO, mPageIndex, mHandler, UIHelper.LISTVIEW_ACTION_REFRESH, UIHelper.LISTVIEW_DATATYPE_TEL_AUDIO);
            }
        });
        ...
        loadThumbByCatalog(AppContext.CATALOG_TEL_AUDIO, 0, mHandler, UIHelper.LISTVIEW_ACTION_INIT, UIHelper.LISTVIEW_DATATYPE_TEL_AUDIO);
        return view;
    }
