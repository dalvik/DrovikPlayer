...
public class FriendCircleFriendDetailResp extends DataResp implements Comparable<FriendCircleFriendDetailResp> {
    ...
    @Override
    public int compareTo(FriendCircleFriendDetailResp another) {
    ...
    public boolean equals(Object o) {
        ...
        FriendCircleFriendDetailResp that = (FriendCircleFriendDetailResp) o;
