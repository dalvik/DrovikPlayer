...
public class FileVideoPager extends BasePager implements FileExplorerActivity.OnFileSearchListener{
    ...
    private static final String IMAGE_CACHE_DIR = "video_thumb";
    private ImageFetcher mImageFetcher;

    private List<FileDetail> searchElementInfos;


    private String TAG = "FileVideoPager";

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        FileExplorerActivity context = (FileExplorerActivity) getActivity();
        context.setOnFileSearchListener(FileVideoPager.this);
    }

    @Override
    protected View createView(LayoutInflater inflater, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_file_video_timeline_gridview, null);
        ...
        initImageFetcher();
        mStickyGridAdapter = new FileTimeLineGridAdapter(getActivity(), searchElementInfos, mLocalImageGridView, mImageFetcher);
        ...
        mRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshlayout) {
                ...
                mOffset = 0;
                mPageIndex = 0;
                loadThumbByCatalog(AppContext.CATALOG_GALLERY_VIDEO, mPageIndex, mHandler, UIHelper.LISTVIEW_ACTION_REFRESH, UIHelper.LISTVIEW_DATATYPE_GALLERY_VIDEO);
            }
        });
        ...
        mRefreshLayout.setOnLoadmoreListener(new OnLoadmoreListener() {
            ...
            public void onLoadmore(RefreshLayout refreshlayout) {
                isLoadMore = true;
                loadThumbByCatalog(AppContext.CATALOG_GALLERY_VIDEO, mPageIndex, mHandler, UIHelper.LISTVIEW_ACTION_SCROLL, UIHelper.LISTVIEW_DATATYPE_GALLERY_VIDEO);
            }
        });
        mLocalImageGridView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                if(mStickyGridAdapter.isChooseMode()) {
                    FileExplorerActivity context = (FileExplorerActivity) getActivity();
                    context.onFileChecked(FileVideoPager.this, -1);
                } else {
        ...
        mLocalImageGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(mStickyGridAdapter.isChooseMode()) {
                    ...
                    FileExplorerActivity context = (FileExplorerActivity) getActivity();
                    context.onFileChecked(FileVideoPager.this, getCheckedCount());
                } else {
        ...
        loadThumbByCatalog(AppContext.CATALOG_GALLERY_VIDEO, 0, mHandler, UIHelper.LISTVIEW_ACTION_INIT, UIHelper.LISTVIEW_DATATYPE_GALLERY_VIDEO);
        return view;
    }
    ...
    private void initImageFetcher() {
        int thumbSize = getResources().getDimensionPixelSize(R.dimen.image_thumbnail_size);
