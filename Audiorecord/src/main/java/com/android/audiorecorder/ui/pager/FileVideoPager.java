...
public class FileVideoPager extends BasePager {
    ...
    protected View createView(LayoutInflater inflater, Bundle savedInstanceState) {
        ...
        initImageFetcher();
        mStickyGridAdapter = new FileTimeLineGridAdapter(getActivity(), mLocalListViewData, mLocalImageGridView, mImageFetcher);
