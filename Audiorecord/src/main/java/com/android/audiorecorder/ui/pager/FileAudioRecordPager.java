...
public class FileAudioRecordPager extends BasePager implements FileExplorerActivity.OnFileSearchListener{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        context.setOnFileSearchListener(FileAudioRecordPager.this);
    }
        ...
        mLocalImageGridView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                if(mStickyGridAdapter.isChooseMode()) {
                    FileExplorerActivity context = (FileExplorerActivity) getActivity();
                    context.onFileChecked(FileAudioRecordPager.this, -1);
                } else {
        ...
        mLocalImageGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(mStickyGridAdapter.isChooseMode()) {
                    ...
                    FileExplorerActivity context = (FileExplorerActivity) getActivity();
                    context.onFileChecked(FileAudioRecordPager.this, getCheckedCount());
                } else {
