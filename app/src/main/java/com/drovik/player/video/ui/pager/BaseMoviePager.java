...
public abstract class BaseMoviePager extends BasePager {
    ...
    public int[] mChannel = {SCChannel.SHOW, SCChannel.MOVIE, SCChannel.COMIC, SCChannel.DOCUMENTARY, SCChannel.VARIETY};
    public final String EXTRA_CHANNEL_ID = "channelID";
