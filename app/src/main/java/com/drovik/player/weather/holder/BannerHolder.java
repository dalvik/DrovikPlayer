...
public class BannerHolder extends BaseViewHolder<LifeIndexData> implements WeatherCallBack.LifeAdvice {
    ...
    public BannerHolder(View itemView, BaseRecyclerAdapter baseRecyclerAdapter) {
