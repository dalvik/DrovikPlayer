...
import com.drovik.player.news.bean.NewsContentBean;
        ...
        Observable
                .create(new ObservableOnSubscribe<String>() {
                    ...
                    public void subscribe(@NonNull ObservableEmitter<String> e) throws Exception {
                        try {
                            Response<ResponseBody> response = RetrofitFactory.getRetrofit().create(INewsApi.class).getNewsContentRedirectUrl(url).execute();
                            // 获取重定向后的 URL 用于拼凑API
