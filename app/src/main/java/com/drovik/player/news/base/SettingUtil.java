package com.drovik.player.news.base;
...
public class SettingUtil {
    ...
    private SharedPreferences setting = PreferenceManager.getDefaultSharedPreferences(SailorCast.getContext());
    ...
    public boolean getIsNoPhotoMode() {
        return setting.getBoolean("switch_noPhotoMode", false) && NetworkUtil.isMobileConnected(SailorCast.getContext());
    }
     ...
     */
    public int getColor() {
        int defaultColor = SailorCast.getContext().getResources().getColor(R.color.colorPrimary);
    ...
    public boolean getIsVideoAutoPlay() {
        return setting.getBoolean("video_auto_play", false) && NetworkUtil.isWifiConnected(SailorCast.getContext());
    }
